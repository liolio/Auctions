<?php
/**
 * @class TestCase_Migration_TableStructure_BankingInformation
 */
class TestCase_Migration_TableStructure_BankingInformation implements TestCase_Migration_TableStructure
{
    ...
    public static function getStructure($versionNumber)
    {
        ...
        {
            case 11 :
                return self::_getStructureFromVersion11();
            case 12 :
    ...
    private static function _getStructureFromVersion11()
    {
        return array(
            array(
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'bank_name',
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'account_number',
                TestCase_Migration::COLUMN_TYPE      =>  'varchar(100)',
                TestCase_Migration::COLUMN_NULL      =>  'NO',
                TestCase_Migration::COLUMN_KEY       =>  '',
                TestCase_Migration::COLUMN_DEFAULT   =>  null,
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'currency',
                TestCase_Migration::COLUMN_TYPE      =>  'varchar(100)',
                TestCase_Migration::COLUMN_NULL      =>  'NO',
                TestCase_Migration::COLUMN_KEY       =>  '',
                TestCase_Migration::COLUMN_DEFAULT   =>  null,
    ...
    private static function _getStructureFromVersion12()
    {
        return array(
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'id',
    ...
    private static function _getStructureFromVersion14()
    {
        return array(
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'id',

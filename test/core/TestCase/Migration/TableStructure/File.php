<?php
/**
 * @class TestCase_Migration_TableStructure_File
 */
class TestCase_Migration_TableStructure_File implements TestCase_Migration_TableStructure
{
    ...
    private static function _getStructureFromVersion21()
    {
        return array(
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'filename',
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'original_filename',
                TestCase_Migration::COLUMN_TYPE      =>  'varchar(255)',
                TestCase_Migration::COLUMN_NULL      =>  'NO',
                TestCase_Migration::COLUMN_KEY       =>  '',
                TestCase_Migration::COLUMN_DEFAULT   =>  null,
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'mime_type',
                TestCase_Migration::COLUMN_TYPE      =>  'varchar(25)',
                TestCase_Migration::COLUMN_NULL      =>  'NO',
                TestCase_Migration::COLUMN_KEY       =>  '',
                TestCase_Migration::COLUMN_DEFAULT   =>  null,
                TestCase_Migration::COLUMN_EXTRA     =>  '',
            ...
            array(
                TestCase_Migration::COLUMN_FIELD     =>  'size',
                TestCase_Migration::COLUMN_TYPE      =>  'varchar(45)',
                TestCase_Migration::COLUMN_NULL      =>  'NO',
                TestCase_Migration::COLUMN_KEY       =>  '',
                TestCase_Migration::COLUMN_DEFAULT   =>  null,
                TestCase_Migration::COLUMN_EXTRA     =>  '',

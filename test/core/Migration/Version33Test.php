<?php
/**
 * @class Migration_Version33Test
 */
class Migration_Version33Test extends TestCase_Migration
{
    ...
    public function migrate()
    {
        $this->_assertTables(array(
            ...
            array(self::TABLES_IN_AUCTIONS_TEST    =>  'delivery_form'),
            ...
            array(self::TABLES_IN_AUCTIONS_TEST    =>  'news'),
        ...
        $this->_assertColumns("delivery_form", TestCase_Migration_TableStructure_DeliveryForm::getStructure($this->_getMigrationVersion()));
        ...
        $this->_assertColumns('news', TestCase_Migration_TableStructure_News::getStructure($this->_getMigrationVersion()));
